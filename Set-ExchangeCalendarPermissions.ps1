...
#This command sets permissions so the delegate can also see Private Items
Set-MailboxFolderPermission JohnDoe:\calendar -User PeterSchmidt -AccessRights Editor -SharingPermissionFlags Delegate,CanViewPrivateItems
